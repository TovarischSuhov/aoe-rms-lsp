...
- Обсуждалась генерическая толерантность («логировать и не ломаться на
  любых неизвестных флагах») — отклонена пользователем: только одно
  явное исключение `-stdio`, неизвестные флаги остаются штатной ошибкой
  flag-парсера
