...
- Итог семантической сверки (2026-09-14): в корпусе (100 карт) нет
  ни одного повтора include одного файла — ни буквального, ни в
  нормализованных написаниях (./, слэши) — легитимных паттернов
  нет, severity warning оставлен без даунгрейда; движковый include
  guard отсутствует (каждая повторная директива выполняет файл
  заново). Прогон корпуса до/после: 119 диагностика на master и на
  ветке, изменений 0
