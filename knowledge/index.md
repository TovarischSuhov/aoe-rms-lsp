...
* [Инварианты стабильности](/architecture/stability-invariants.md) — правила, которые проект сознательно поддерживает: recovery-парсеры, стабильные коды диагностик, stdout только для протокола, данные без сети
